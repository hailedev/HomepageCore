...
describe("<AboutPage />", function(){
    it("should render the main contaner", async function(){
        ...
        const { container } = await act(() => render(<Provider store={store}><StaticRouter location={"/about"} context={{}}><Routes><Route path="/about" element={<AboutPage/>}/></Routes></StaticRouter></Provider>));
