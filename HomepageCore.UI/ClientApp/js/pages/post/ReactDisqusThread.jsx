...
function copyProps(context, props, prefix) {
    Object.entries(props).map((entry) => {
        context[prefix + entry[0]] = entry[1]; // eslint-disable-line
    });
...
export default class ReactDisqusThread extends Component {
    ...
    loadDisqus() {
        ...
        for (let i = 0; i < DISQUS_CONFIG.length; i += 1) {
            const prop = DISQUS_CONFIG[i];
            if (this.props[prop]) {
...
ReactDisqusThread.displayName = 'DisqusThread';
ReactDisqusThread.propTypes = {
     ...
     */
    identifier: PropTypes.string, // eslint-disable-line
     ...
     * for the first time.
     */
    category_id: PropTypes.string, // eslint-disable-line
     ...
     */
    onNewComment: PropTypes.func // eslint-disable-line
};

ReactDisqusThread.defaultProps = function () {
    return {
        shortname: null,
        identifier: null,
        title: null,
