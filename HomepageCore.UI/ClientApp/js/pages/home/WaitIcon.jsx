...
var WaitIcon = createReactClass({
    render: function(){
        ...
        return (
            <svg width={size} height={size} style={this.props.style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="uil-spin">
                ...
                <g transform="translate(50 50)">
                    ...
                    <g transform="rotate(315) translate(34 0)"><circle cx="0" cy="0" r="8" fill="#000">
