...
export default () => {
    ...
    const images = () => window.location.pathname = 'images';
    ...
    const adminNav = (
        <div className="admin-nav">
            <span className="user-name-wrapper">
                ...
                {user ? <span className="user-name">{user.profile.name}</span> : null}
            </span>
            <ul>
                <li><Link to="/admin">Admin</Link></li>
                <li onClick={images} role="presentation">Images</li>
                <li onClick={signOut} role="presentation">Logout</li>
            </ul>
        </div>
    );
    const banner = user ? <img src="/images/react.svg" alt="react" style={{ width: '90px' }} /> : 'Hai Le';
    const ribbon = (
        <Link to="/">
                ...
                <div className="navigation container">
                    <div className="navigation-section">
                        ...
                        <ul className="indicator">
                            <li style={{ width: '20%' }} className={pathname === 'about' || pathname === '/about' ? 'selected' : null}>
                                <div style={{ marginLeft: '5px' }} className="arrow-up" />
                            </li>
                            <li style={{ width: '27%' }} className={pathname === 'projects' || pathname === '/projects' ? 'selected' : null}>
                                <div style={{ marginLeft: '18px' }} className="arrow-up" />
                            </li>
                            <li style={{ width: '25%' }} className={pathname === 'feedback' || pathname === '/feedback' ? 'selected' : null}>
                                <div style={{ marginLeft: '18px' }} className="arrow-up" />
                            </li>
                            <li className={pathname === 'hire-me' || pathname === '/hire-me' ? 'selected' : null}>
                                <div style={{ marginLeft: '10px' }} className="arrow-up" />
                            </li>
                        </ul>
                    </div>
                    {loaded ? ribbon : <div className="ribbon-placeholder" />}
