...
import { setUserInfo, signOutUser } from 'UserActionCreators';
...
class Main extends Component {
    ...
    render() {
        const adminNav = (
            <div className="admin-nav">
                <span className="user-name-wrapper">
                    ...
                    {this.props.user ? <span className="user-name">{this.props.user.profile.name}</span> : null}
                </span>
                <ul>
        ...
        const banner = this.props.user ? <img src="/images/react.svg" alt="react" style={{ width: '90px' }} /> : 'Hai Le';
        const ribbon = (
            <Link to="/">
            ...
            <div>
                    ...
                    <div className="navigation container">
                        <div className="navigation-section">
                            ...
                            <ul className="indicator">
                                <li style={{ width: '20%' }} className={this.props.router.location.pathname === 'about' || this.props.router.location.pathname === '/about' ? 'selected' : null}>
                                    <div style={{ marginLeft: '5px' }} className="arrow-up" />
                                </li>
                                <li style={{ width: '27%' }} className={this.props.router.location.pathname === 'projects' || this.props.router.location.pathname === '/projects' ? 'selected' : null}>
                                    <div style={{ marginLeft: '18px' }} className="arrow-up" />
                                </li>
                                <li style={{ width: '25%' }} className={this.props.router.location.pathname === 'feedback' || this.props.router.location.pathname === '/feedback' ? 'selected' : null}>
                                    <div style={{ marginLeft: '18px' }} className="arrow-up" />
                                </li>
                                <li className={this.props.router.location.pathname === 'hire-me' || this.props.router.location.pathname === '/hire-me' ? 'selected' : null}>
                ...
                <div className="content">
                    <Routes>
                        ...
                        <Route path="/hire-me" element={<ResumePage/>} />
...
export default withRouter(connect(mapStateToProps, { setUserInfo, signOutUser })(Main));
